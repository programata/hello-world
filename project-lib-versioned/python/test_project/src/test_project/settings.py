...
from analyticsbk.framework.dataquality import store_expectation_result
from analyticsbk.plugin.hooks import DynamicParamsHook, DataQualityHook
from analyticsbk.plugin.hooks.temp_file_hook import TempFileHook
from test_project.context import ProjectContext
from test_project.hooks import ProjectHooks

# Instantiate and list your project hooks here
HOOKS = (ProjectHooks(), DynamicParamsHook(), DataQualityHook(store_expectation_result), TempFileHook())

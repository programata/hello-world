...
dku_project_versioned = os.environ.get(
    key='DKU_PROJECT_LIB_VERSIONED_LOCATION', 
    default='/home/dataiku/lib/project/project-python-libs/FIRSTANALYTICSTRACERBULLET'
)

os.chdir(f'{dku_project_versioned}/python/test_project')

sys.path.append(f'{dku_project_versioned}/python/test_project/src/test_project/')
